<%@ page import="com.germanyTree.service.*"%>
			...
			<div class="container">
				<div class="row">
					<div class="col-12">
						...
						<img src="resources/img/core-img/logo.jpg" alt=""></a>
					</div>
				</div>
			</div>
		</div>
							...
							<div class="classynav">
								<ul>
									<li><a href="index">홈</a></li>
									 ...
									 <li><a href="videoView">부동산 매물</a></li>  
