...
<body>
	...
	<form>
		...
		<input id="textMessage" onkeydown="return enter()">
		<!-- 서버로 메시지를 전송하는 버튼 -->
	...
	<script type="text/javascript">
		...
		var webSocket = new WebSocket("ws://localhost/germanyTree/broadsocket");
		// 콘솔 텍스트 영역
		...
		webSocket.onerror = function(message) {
			// 콘솔에 메시지를 남긴다.
			messageTextArea.value += "안녕하세요. 독일트리입니다. 현재 다른 클라이언트와 상담중입니다. "
					+ "성함과 연락처를 남겨주시면 바로 연락드리겠습니다."+ "\n";
		};
